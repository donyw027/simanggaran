    ...
    <div class="col-md-8">
        <div class="card shadow-sm mb-4 border-bottom-primary">
            ...
            <div class="card-body pb-2">
                ...
                <?= form_open('', [], ['id' => $subcoa1['id']]); ?>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="NO_SUB_COA_1">NO_SUB_COA_1</label>
                    <div class="col-md-6">
                        <input value="<?= set_value('NO_SUB_COA_1', $subcoa1['NO_SUB_COA_1']); ?>" type="text" id="NO_SUB_COA_1" name="NO_SUB_COA_1" class="form-control" placeholder="NO_SUB_COA_1">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?= set_value('INDUK_COA', $subcoa1['INDUK_COA']); ?>" type="text" id="INDUK_COA" name="INDUK_COA" class="form-control" placeholder="INDUK_COA">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?= set_value('NAMA_PERKIRAAN', $subcoa1['NAMA_PERKIRAAN']); ?>" type="text" id="NAMA_PERKIRAAN" name="NAMA_PERKIRAAN" class="form-control" placeholder="NAMA_PERKIRAAN">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?= set_value('TIPE', $subcoa1['TIPE']); ?>" type="text" id="TIPE" name="TIPE" class="form-control" placeholder="Jabatan">
